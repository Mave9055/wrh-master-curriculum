...
*   **Applied Suicide Intervention Skills Training (ASIST)**: Certification in ASIST, demonstrating proficiency in suicide first aid.
*   **Suicide Assessment Five-step Evaluation and Triage (SAFE-T)**: Certification in SAFE-T, indicating competence in structured suicide risk assessment and triage.
*   **VA-Approved 6-Hour Live Suicide-Prevention Curriculum**: Completion of a Department of Veterans Affairs (VA) approved, in-person, 6-hour minimum suicide prevention curriculum. *Note: Online-only modules are not accepted as fulfilling this requirement.*

## **2.0 Highly Recommended Professional Qualifications**
...
*   **Master’s-Level Clinician**: Possession of a Master’s degree in a clinical field (e.g., Licensed Clinical Social Worker (LCSW), Licensed Professional Counselor (LPC), Licensed Marriage and Family Therapist (LMFT), Doctor of Psychology (PsyD), Doctor of Philosophy (PhD)).
*   **Certified Peer Specialist**: Certification as a Peer Specialist with demonstrated advanced training in crisis management.
*   **Supervised Co-Facilitation**: Engagement in co-facilitation with a qualified clinical supervisor for the initial three (3) program cohorts to ensure mentorship and quality assurance.
