...
*   **Procedure**: 
    ...
    4.  Physical escort of participant to clinical support area.
    5.  Documentation of incident (see Section 3.0).
*   **Reference**: [Standardized Safety Language Template](./Safety_Language_Template.md)
...
**Session 12 (Internal Behavioral Conflict Systems)**, due to its inherent potential for high participant activation, **mandates a minimum of Tier 2 (Structured) delivery**, with **Tier 3 (Clinical) highly recommended** for optimal safety and support. The [Session 12 Pilot Portal](../Part-I/Session_12_Pilot_Portal.md) reflects these stricter requirements.
...
1.  **Immediate Notification**: Any adverse event (e.g., participant distress requiring SPI, significant behavioral disruption) must be reported to the Program Coordinator within 1 hour.
2.  **Detailed Incident Report**: A comprehensive report, utilizing the S-Prefix Metric Framework, must be completed within 24 hours.
3.  **7-Day Follow-up**: Program Coordinator conducts a follow-up with the participant (or clinical team, if handoff occurred) within 7 days to assess well-being and program impact.
