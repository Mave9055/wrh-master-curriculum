# SESSION 17: BOUNDARIES ARE NOT WALLS; THEY ARE BRIDGES
...
### **Session Overview**
**Goal:** Reveal that healthy boundaries are flexible and allow connection while protecting the nervous system. Shift the perspective from "I have no boundaries/rigid walls" to "Saying no is an act of self-love."
...
1.  **Identify the Boundary:** Think of one thing you need to say no to (e.g., 'I can't take on another project' or 'I need to go home now').
2.  **State the Boundary:** Use a complete sentence. (e.g., 'I care about you, and I need to take care of myself right now.' or 'That doesn't work for me.' or 'I need to think about that.')
3.  **The Self-Love Statement:** 
    - Silently say to yourself: 'Saying no is an act of self-love. I am the driver.' 
    - Take a long, slow breath out.

**Group Activity:**
"Right now, think of one thing you need to say no to this week. 
